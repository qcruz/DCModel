...
The observed Higgs mass (125 GeV) is then almost entirely a **radiative effect**, generated by
quantum corrections as you run from the compactification scale down to the electroweak scale.

The dominant correction comes from the top quark loop:

```
m²_H ≈ (3 y_t² / 4π²) m²_t × ln(M_c² / m_t²)
```

where y_t is the top quark Yukawa coupling, m_t ≈ 173 GeV is the top mass, and M_c is the
compactification scale.

This is why the top quark matters so much for Higgs physics — in this model, the top quark
literally generates the Higgs mass through quantum corrections.
...
compactification scale (by symmetry of the modulus). The stability boundary IS the compactification
...
coincide (within uncertainty) with the compactification scale. If future experiments could measure
the running of the Higgs quartic more precisely, they could constrain the compactification scale.
...
- Running of λ from compactification scale to electroweak scale
