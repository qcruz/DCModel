...
4. **SU(N) generality T3→T2a (+10% CPC)** [C215 establishes T3 overall]: T1 key result — I₄=C₂(fund,SU(N)) unique to N=3 (polynomial residual 0.00e+00). Structural extension to all SU(N) T3: AF [T1], OS-Seiler [T1+literature], Seiler-Simon [T1]. KP<1 for N≥3 [T2a]. Gap existence for N≥4 structural [T3]. Path to +10% CPC: Binder FSS for N=4 at β_lat=3N³/4=48 (KP=0.0032 << 1 → easy numerical check).
