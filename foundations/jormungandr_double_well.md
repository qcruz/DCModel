...
## 2. What the DFC Math Currently Shows

The double-well potential V(φ) = −α/2 φ² + β/4 φ⁴ is currently **postulated**
(Tier 0 — core postulate). Its structure is motivated by three physical
requirements:
...
2. **The BPS bound has a gravitational interpretation.** Currently E_kink = S_kink
   ...
   should relate to a gravitational action (possibly the Gibbons-Hawking boundary
   term S_GH = A/(16πG)).
