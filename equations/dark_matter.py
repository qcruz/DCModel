...
if __name__ == "__main__":
    ...
    print(f"  M_c(D4) = {M_C_D4_GEV:.3e} GeV  [inertia closure scale]")
    print(f"  M_c(D5) = {M_C_D5_GEV:.3e} GeV  [U(1) gauge closure]")
    print(f"  M_c(D5) / M_c(D4) = {ratio_D5_D4:.4f}")
    print(f"  Dark matter candidates: intermediate kink modes between D4 and D5")
    print(f"  Mass range: O({M_C_D5_GEV:.0e} - {M_C_D4_GEV:.0e}) GeV")
