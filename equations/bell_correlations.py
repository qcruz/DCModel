...
if __name__ == "__main__":
    ...
    print(f"")
    print(f"  Bell factorizability fails: the joint substrate state is irreducibly")
    print(f"  joint (Lambda_AB != Lambda_A x Lambda_B). The decomposition into")
    print(f"  spatially separated independent systems is an emergent approximation.")
    print(f"  Deriving P(A,B|a,b) from substrate dynamics is OPEN.")
    print(f"")
