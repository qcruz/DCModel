...
```
Current estimate: ~65%  (viability: ~76%, mathematical rigor: ~54%)
...
Next milestone: Bottleneck 3 — v=246 GeV from D6/D7 overlap using Δ_D67=5.08; α_s — derive M_c(D7) from substrate depth-running (not SM inversion); Koide Step 4d Tier 3→2a (F(γ)=1/√Q_top from explicit DFC 5D vortex BVP integral).
