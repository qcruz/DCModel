...
SP5 (Λ_QCD from V(φ), T4→T3) → SP3 (topological QFT spectrum, T3→T2a) → SP2 4D
(SP1f T4→T3 done Cycle 186; SP4 T2a done; SP2 T2a 1+1D done; remaining T4: SP5 + SP1 R1/R2).
