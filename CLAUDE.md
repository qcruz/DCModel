...
SP5 threshold corrections at m_KK (KK spectrum sum) → SP1 Balaban 4D convergence
(R2 T4→T3 done Cycle 192; C_match T4→T2a done Cycle 191; R1 T4→T3 done Cycle 190; SP2 T3(4D) done Cycle 189; SP5 T4→T3 done Cycle 188; SP3 T3→T2a done Cycle 187; SP1f T4→T3 done Cycle 186; SP4 T2a done; remaining open: SP5 threshold corrections + SP1 Balaban).
