...
Next milestone: prove r_U1/λ = πN_Hopf/I₄ from V(φ) KK mode normalization integral — this single equation closes Bottleneck 2 (β→Tier 2a, g²=8/27→Tier 2a, zero free parameters)
