...
SP5 C_match (MS-bar matching at m_KK) → SP1 R2 (Wilson measure → Gaussian measure)
(SP1 R1 T4→T3 done Cycle 190; SP2 T3(4D) done Cycle 189; SP5 T4→T3 done Cycle 188; SP3 T3→T2a done Cycle 187; SP1f T4→T3 done Cycle 186; SP4 T2a done; remaining open: SP5 C_match + SP1 R2).
