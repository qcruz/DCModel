...
Next milestone: prove R_n/λ = πd_n/I₄ from DFC moduli space metric of n coincident kinks, or equivalently from KK normalization integral on S^{d_n}(R_n) × ℝ → all Tier 3 results promote to Tier 2a (g²=8/27, β=1/(9π), zero free parameters)
