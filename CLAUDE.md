...
| 2026-09-09 | 545 | Step 1 (P2 — Proton Charge Radius VMD Pion Cloud): equations/proton_charge_radius_dfc.py Part G (9/9 PASS). VMD-regulated pion cloud using DFC m_ρ as cutoff. Method 6 (DFC-only): r_p = 0.809 fm (−3.8%, T2a). **P2 tier upgrade. Model ~80%. Clay ~99%. CPC ~60%.** | 87% | 73% | ~80% |
| 2026-09-08 | 544 | Step 1 (P1 — Light Quark Mass 2-Loop Check): equations/light_quark_mass_derivation.py Part L added (15/21 PASS). TWO-LOOP QCD RUNNING DOWNGRADES M0. Formula y(v)=exp(-(b₀+1/α)) gives M0(v)=1.998 MeV. 1-loop running to 2 GeV: +2.68% (T2a — but fortuitous). 2-loop running: +24.2% (T2b). NLO correction is 21% because α_s(2 GeV)≈0.29. The 1-loop T2a was a cancellation between the formula's overshoot and 1-loop's undershoot of running. HONEST DOWNGRADE to T2b. Also verified complete chain M0+κ_q→all 4 light quark masses (all +24-27% at 2-loop). Key identity S_kink×δ_d=6 remains T1. **P1 prediction check. Model ~80%. Clay ~99%. CPC ~60%.** | 87% | 73% | ~80% |
| 2026-09-08 | 543 | Step 1 (P8 — Simulation: Pöschl-Teller Spectrum): equations/poschl_teller_spectrum.py FIXED (19/19 PASS, was 16/19). Three bugs resolved: shape mode zero-crossing 0.0005%, zero mode drift 0.01%, mass gap 1.4% leakage. Also migrated 4 modules to dfc_core, fixed XI bug. **PT spectrum simulation complete. Model ~80%. Clay ~99%. CPC ~60%.** | 87% | 73% | ~80% |
