...
```
Current estimate: ~53%  (viability: ~65%, mathematical rigor: ~41%)
...
Next milestone: show DFC 5D KK action, integrated over kink profile with gauge fluctuation, equals det(g_{moduli}) = 2I₄ — this promotes g_1²=det(g) from Tier 2 candidate to Tier 2a and closes Bottleneck 2
