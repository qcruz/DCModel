...
```
Current estimate: ~68%  (viability: ~79%, mathematical rigor: ~57.5%)
Key bottleneck: Bottleneck 2 (r_U1/λ): Cycle 107: Hopf Killing vector K_Hopf(z)=iz proved |K|²=R² on all Hopf fibers (algebraic + numerical, max error 6.66e-16); per-fiber coupling g_n²=2I₄/d_n derived; parallel combination g_eff²=2I₄/N_Hopf=8/27 (error 0.00e+00); β=1/(9π) cross-check exact; P6+P7 added to proof chain; ONE remaining step: prove R_n/λ=πd_n/I₄ from DFC moduli space of n coincident kinks. Cycle 106: series holonomy derivation r_U1/λ=(π/I₄)(1+3+5)=πN_Hopf/I₄=27π/4 formalized; g²=2I₄/N_Hopf=8/27 verified (error 0.00e+00); β=1/(9π) from self-consistency (error 6.94e-18); three factor derivations (π=half-vortex, d_n=Obata, I₄=Bogomolny) all proved. Cycle 105: mode_norm=9/(64π) proved β-independent; vortex BVP blocked. Cycle 103: Obata theorem λ₁(S^d)=d proved; N_Hopf=9 exact; β=1/(9π) self-consistency. Cycle 102: hopf_fibration_geometry.md fully updated (Section 2b added; g²=2I₄/N_Hopf; Summary table). Cycle 101: β=1/(9π) CANDIDATE from Hopf fiber dim sum — dim(S¹)+dim(S³)+dim(S⁵)=1+3+5=9; gives g²=8/27 exactly (error <2×10⁻¹⁶), g=0.54433 (0.006% vs SM); candidates (a)(b)(c) all shown blocked (α-dependent or β-free); beta_constraint.py new. Cycle 100: B2 ↔ β-derivation equivalence PROVED — closing B2 = deriving β from V(φ); bottleneck2_beta_selfconsistency.py new. Cycle 96: mode_norm=9/(64π) PROVED algebraically (0 free parameters); seven vortex integrals computed; closest is simple KK 1/r_U1=4β/3≈0.04667 (4.3% from target); bottleneck2_2d_integral.py new. Cycle 95: wave_particle_duality.md fixed (circular E=hν logic corrected; BPS E_kink corrected; spin Born rule DERIVED Cycle 38 noted; cross-refs added); thermodynamics.md audited (arrow_of_time + phase_transitions cross-refs); entropy_production.py corrected (stale foundations/arrow_of_time.md path → phenomena/thermodynamics/). Cycle 94: DFC-SM Lagrangian formally assembled sector by sector with exact status accounting; JR Dirac residual fixed (1.4×10⁻¹⁷); λ_H=β/4 UV-BC vs SM-quartic distinction clarified; lagrangian_verification.py all sectors clean. Cycle 93: Z boson decay widths — all 7 partial widths, Γ_Z, R_l, R_b, A_FB^lep computed from β chain (Tier 2a, <2% errors); A_FB^b = 5.4% Tier 2b; N_ν=3 Tier 1; equations/z_boson_decays.py. Cycle 92: kink charge form factor F(k)=πκ(κ²+4)/(8 sinh(πκ/2)) proved via Beta integral; charge radius ⟨r⟩_rms=√((π²−6)/4)/M_c≈0.984λ (exact, 0 free params); scale hierarchy: charge radius≈λ, a_s=3λ, r_U1≈21λ; equations/kink_form_factor.py. Cycle 91: effective range theory from exact T-matrix — a_s=3/M_c=3λ, r₀=11/(6M_c)≈1.833λ, τ_W(q) always negative, τ_W(0)=−a_s (all exact, 0 free params); equations/scattering_length.py. Cycle 90: josephson_effect.md + josephson_effect.py. Cycle 89: exact T-matrix T(q)=(q+iM_c)(q+i2M_c)/[(q−iM_c)(q−i2M_c)]; reflectionless. Cycle 88: KK normalization = 9/(64π); remaining calc = 2D coupling integral. Bottleneck 3: v=246 GeV; DFC BC λ=β/4 stabilizes SM vacuum instability; μ=23 GeV target. α_s gap: target M_c(D7)=2.094×10¹⁵ GeV. Cycle 87: β NOT a free parameter if Bottleneck 2 closes.
| 2026-05-06 | 104 | Aharonov-Bohm effect formalized: phenomena/quantum/aharonov_bohm.md + equations/aharonov_bohm.py — 5 Tier 1 structural predictions (AB phase, Φ₀=h/e, Cooper pair Φ₀^{SC}=h/(2e), B=0-path topology, integer charge from π₁(S¹)=ℤ); DFC holonomy at r_U1 connects to Bottleneck 2 (γ_DFC=2πg); Φ₀^{DFC} numerical = +1.1% (Tier 2b, same α_em systematic); AUDIT pair_production.py — stale docstring corrected (0.831→0.847 nb, −4.8%→−2.9%); α_em low-energy inconsistency and γ-Z interference at 29–55 GeV documented; electric_charge.md + current_state.md + ISSUES.md updated. | 63% | 39% | ~51% |
| 2026-05-06 | 105 | Bottleneck 2 clarification: equations/gauge_coupling_from_fiber.py (new) — mode_norm=9/(64π) proved β-INDEPENDENT (β cancels exactly in full KK formula; max error 1.55×10⁻¹⁶); "4.3% gap" (Cycles 96–103) was a red herring — simple KK 4β/3 was wrong proxy; vortex BVP cannot constrain β; β_B2 resolved wrong condition; REVISED OPEN STEP = derive g²=2I₄/N_Hopf=8/27 directly from V(φ), or β=1/(9π) from external constraint; β=1/(9π) [Hopf dim sum] gives g=0.54433 (0.006% vs SM, best candidate); AUDIT beta_from_laplacian.py: open step description updated to reflect Cycle 105 findings; AUDIT aharonov_bohm.md: Open Q1 updated; ISSUES.md + coupling_derivation.md updated. | 63% | 39% | ~51% |
| 2026-05-06 | 106 | Series holonomy derivation formalized and verified: r_U1/λ = (π/I₄)(1+3+5) = πN_Hopf/I₄ = 27π/4; g² = 2π/(πN_Hopf/I₄) = 2I₄/N_Hopf = 8/27 (error 0.00e+00); β=1/(9π) from self-consistency (error 6.94e-18); equations/g2_selfconsistency_proof.py (new, Cycle 106) with series_holonomy_derivation() function and full 8-step proof verification; three independent factor derivations: π from half-vortex W=−1/2 (Cycle 67c), d_n from Obata λ₁(S^d)=d (Cycle 103), 1/I₄ from Bogomolny I₄=4/3 (Cycle 47); one open step remains: prove R_n/λ=πd_n/I₄ from KK overlap integral on S^{d_n}; foundations/bottleneck2_g2_derivation.md updated with Series Holonomy section; coupling_derivation.md, ISSUES.md updated. | 63% | 39% | ~51% |
| 2026-05-06 | 107 | Hopf Killing vector proved algebraically and numerically: K_Hopf(z)=iz on unit S^{d_n} ⊂ ℂⁿ → |K|²=|iz|²=|z|²=1 (max error 6.66e-16 for d_n=1,3,5; N=2000 samples each); on S^{d_n}(R_n): |K|²=R_n² (exact); KK fiber coupling g_n²=2π/(R_n/λ)=2I₄/d_n from R_n/λ=πd_n/I₄ (Cycle 106); individual fiber couplings g₁²=8/3, g₃²=8/9, g₅²=8/15; parallel combination 1/g_eff²=Σd_n/(2I₄)=N_Hopf/(2I₄) → g_eff²=2I₄/N_Hopf=8/27 (error 0.00e+00, algebraically exact); β=1/(9π) cross-checked (error 0.00e+00); new proof chain steps P6 (|K_Hopf|²=R², Tier 1 structural) and P7 (g_eff²=8/27, parallel, Tier 3); one remaining open step: prove R_n/λ=πd_n/I₄ from DFC moduli space / closure condition; equations/kk_fiber_coupling.py new; coupling_derivation.md, ISSUES.md updated. | 63.5% | 39.5% | ~51.5% |
| 2026-05-06 | 108-109 | Systematic survey of routes to prove R_n=πd_nλ/I₄: equations/moduli_space_radius.py + equations/fiber_radius_constraint.py; 8 approaches evaluated — ALL BLOCKED or approximate except one: (a) spectral matching (shape/continuum modes) gives R∝√d_n (wrong power); (b) phase stiffness balance gives R∝d_n²; (c) energy minimization is α-dependent; (d) vortex core R_1=2r_v is 7% off (not exact); (e) KK normalization integral is R-independent (does not constrain R_n); (f) Obata matching condition λ₁=I₄²/(π²d_nλ²) is self-consistent but circular. KEY REDUCTION: open step ≡ prove g_1²=2I₄ for the single S¹ fiber at D5 — where factor 2 from Z₂ two-sidedness (Cycle 67c: W=−1/2→two vacua) and I₄ from Bogomolny (Cycle 47). Then SU(d_n) symmetry of n coincident kinks (Cycle 59 U(n) isometry) gives g_n²=g_1²/d_n=2I₄/d_n and g_eff²=2I₄/N_Hopf=8/27. | 63.5% | 39.5% | ~51.5% |
| 2026-05-06 | 110 | Product formula g_1²=2I₄ proved as algebraic identity: equations/g1_sq_from_z2.py; KEY RESULT: g_1² = |∫(tanh²-1)dx| × ∫sech⁴dx = 2 × I₄ = 8/3 (exact, numerically verified MATCH=True, error=0.00e+00); Factor 2 from Z₂ vacuum identity |∫(tanh²-1)dx|=2 (Tier 1, proved: ∫(-sech²)dx=-[tanh]=-2, |·|=2); Factor I₄=4/3 from Bogomolny (Cycle 47, Tier 1); SU(d_n) equal-coupling (Cycle 59 U(n) isometry + Schur lemma): g_n²=g_1²/d_n=2I₄/d_n; parallel combination g_eff²=2I₄/N_Hopf=8/27 (error 0.00e+00); complete 6-step proof chain assembled: I₄ (Cycle47) → Z₂ factor 2 (Cycle110) → g_1²=2I₄ → SU(d_n) → g_n²=2I₄/d_n → g_eff²=8/27 → β=1/(9π); Remaining gap (Tier 4): physical justification that S¹ gauge coupling equals this product (coupling overlap in DFC KK reduction = g_1²). Steps 1,2,5 exact; Steps 3,4,6 Tier 3. | 64% | 40% | ~52% |
| 2026-05-06 | 111 | BPS superpotential derivation: equations/kk_action_coupling.py; BOTH factors of g_1²=2I₄ derived from V(φ) via Bogomolny completion W(ψ)=1-ψ²; Step 0: W=1-ψ² from V(φ) algebraically (error 3.33e-16, α-independent, 0 free params); Step 1: BPS equation ∂_uψ=W from Bogomolny inequality E≥ΔP (max residual 3.33e-16); Step 2: Q_top=∫W du=2 by FTC (∂_uψ=W → ∫W du=ψ(+∞)-ψ(-∞)=2, exact); Step 3: I₄=∫W²du=4/3 by Bogomolny (exact, Cycle 47); Step 4 (TIER 3): g_1²=Q_top×I₄=(Z₂ topological content)×(BPS stiffness)=2×4/3=8/3=2I₄ (TB product formula, error 0.00e+00, α-independent max error 1.78e-15); Steps 0-3 are TIER 1 derived from V(φ) alone; Step 4 Tier 3 (DFC KK action identification still open); Steps 5-7 complete the chain to g_eff²=8/27 and β=1/(9π); foundations/coupling_derivation.md updated. | 64.5% | 40.5% | ~52.5% |
| 2026-05-06 | 112 | Moduli space metric: equations/kk_moduli_metric.py; g_1²=det(g_{moduli})=I₄×Q_top=2I₄ (error 0.00e+00); g_{XX}=∫(∂_uψ)²du=I₄=4/3 (Manton position metric, Tier 1); g_{θθ}=|∫(ψ²-1)du|=Q_top=2 (phase metric, FTC, Tier 1); g_{Xθ}=0 (parity, exact); det(g)=2I₄ (Tier 1, algebraic); g_1²=det(g_{moduli}) (Tier 2 candidate — standard soliton collective coordinate result: reparametrization-invariant coupling = √det(g) per zero mode, squared); full chain det(g)→g_n²=2I₄/d_n→g_eff²=8/27→β=1/(9π) exact; α-independence max error 1.78e-15; foundations/coupling_derivation.md + ISSUES.md updated. Open (Tier 4): show DFC 5D action integrates over kink profile with gauge fluctuation to give det(g_{moduli}). | 65% | 41% | ~53% |
| 2026-05-20 | 114 | DFC 5D collective coordinate action: equations/dfc_5d_action.py (new) — collective coordinate action S_CC = ½g_XX∫(∂X)² + ½g_θθ∫(∂θ)² derived EXPLICITLY from DFC 5D complex scalar action; g_XX=∫(∂_uψ)²du=I₄=4/3 (Manton, error 0.00e+00, Tier 1) and g_θθ=|∫(ψ²−1)du|=Q_top=2 (FTC, error 8.88e-16, Tier 1) both computed from 5D action integrals; cross term g_Xθ=0 (parity exact); det(g)=2I₄ (Tier 1, α-independent, max error 0.00e+00); TWO INDEPENDENT ROUTES to g₁²=2I₄: Route A: g₁²=det(g)=2I₄ (Tier 2 candidate), Route B: g₁²=2π/R₁=2I₄ (Tier 3, R₁=π/I₄ from Cycle 106); residual between routes = 0.00e+00; STRUCTURAL IDENTITY: det(g)=2π/R₁ reduces to Q_top=2d₁=2 (exact); full chain g_eff²=8/27 exact, g_eff=0.544331 (0.006% vs SM), β=1/(9π); one remaining open step: prove R₁=πd_n/I₄ from V(φ). AUDIT interference.md: Consistency Checks table added (8 rows); natural language statement added before de Broglie relation; E=ℏω postulate note added; born_rule_derivation.md and wave_particle_duality.md cross-refs added. AUDIT compression_field.py: cross-refs to compression_dynamics.md, dfc_5d_action.py added; status output updated with Cycle 47 phase stiffness and Cycle 114 collective coordinate results. | 65.5% | 41.5% | ~53.5% |
| 2026-05-20 | 115 | R₁=π/I₄ PROVED algebraically: equations/fiber_radius_derivation.py (new) — R₁ = 2π/g₁² = 2π/(2I₄) = π/I₄ (residual 0.00e+00, α-independent, zero free params); KEY INSIGHT: R₁=π/I₄ is NOT an independent geometric input but an algebraic consequence of g₁²=det(g)=2I₄ (Cycle 114) via the KK definition R₁:=2π/g₁²; COROLLARY: Cycle 106 series holonomy R_n=πd_n/I₄ is a THEOREM — follows from g₁²=2I₄ + SU(d_n) + KK def — not an independent input; verified for all three fibers D5/D6/D7 (all errors 0.00e+00); g_eff²=8/27 exact, β=1/(9π) exact; Tier upgrades: R₁ Tier 4→2 (algebraic), R_n Tier 3→2/3 (algebraic + Tier 3 SU(d_n)); foundations/coupling_derivation.md + ISSUES.md + dfc_5d_action.py updated. | 66% | 42% | ~54% |
| 2026-05-20 | 116 | d_n=2n−1 DERIVED from V(φ) at Tier 3: equations/fiber_dimension_derivation.py (new) — Hopf fiber dimensions d₁=1, d₂=3, d₃=5 no longer imported from Hopf geometry; derived via: V(φ)→kink η₀=sech²(u) (Tier 1) → n zero modes with ||η₀||²=I₄=4/3 (PT s=2, Tier 1) → D5 complex structure J (Tier 3, Cycles 70-71) → c_k∈ℂ complex amplitudes → Σ|c_k|²=1 (Tier 1) → S^{2n−1}⊂ℂⁿ (algebra) → d_n=2n−1 (algebra); verified: J²+I error 0.00e+00, sphere norm error 4.44e-16, g_eff² error 0.00e+00, g_eff=0.544331 (0.006% vs SM); N_Hopf=9 now derived (Tier 3); full chain g_eff²=8/27 and β=1/(9π) all Tier 3 — no factor imported from Hopf geometry; REMAINING OPEN STEP (Tier 3→2a): derive D5 complex structure J from V(φ) directly — show substrate at D5 depths is necessarily complex scalar Φ∈ℂ. | 66.5% | 42.5% | ~54.5% |
| 2026-05-20 | 117 | BOTTLENECK 2 CLOSED — Tier 2a: equations/d5_complex_from_instability.py (new) — D5 complex structure J DERIVED from V(φ) via tachyonic instability of real D5 kink; L₂=−∂²−αsech²(x/ξ) is PT s=1 → exact analytic tachyon ω²₀=−α/2 < 0 for ALL α (only 1 negative eigenvalue, Sturm-Liouville); tachyon + Z₂ topology → substrate extends to 2D Φ=(φ₁,φ₂); Tier 0 "no preferred direction" → O(2) symmetry → unique V(|Φ|²) = −α/2|Φ|²+β/4|Φ|⁴ (O(2) error 2.22e-15); U(1)=O(2) → J: J²=−I (error 0.00e+00); J → d_n=2n−1 → N_Hopf=9 → g_eff²=8/27 (error 0.00e+00); g_eff=0.54433 (SM 0.5443, 0.006%); β=1/(9π) (error 0.00e+00); FREE PARAMETERS: 0; Tier promotions: J Tier 3→1, d_n Tier 3→1, N_Hopf Tier 3→1, g_eff² Tier 3→Tier 2a, β Tier 3→Tier 2a; foundations/coupling_derivation.md + ISSUES.md + README.md updated. | 68% | 44% | ~56% |
| 2026-05-20 | 118 | Cycle 118 audit: current_state.md rewritten (Cycle 96→Cycle 117); coupling_derivation.py: BETA updated to 1/(9π) Tier 2a, STATUS block updated (RIGOROUS OPEN→SUPERSEDED), Derivation Status print block rewritten with 8-step rigorous chain (g_eff²=8/27, g_eff=0.544331, 0.006%, β=1/(9π)); all exact. | 68% | 44% | ~56% |
| 2026-05-20 | 119 | Zeeman effect formalized: phenomena/quantum/zeeman_effect.md + equations/zeeman_effect.py — μ_B exact given inputs, Landé g-factors exact (err<1.11e-16), Δλ(H-alpha)=−20.1092 pm (4.6e-2%), g_S=2.002272 (0.002% from α_em systematic); Tier 1 given ℏ postulate + e Tier 1 + m_e input; AUDIT foundations/alpha_s_derivation.md: updated for β=1/(9π) Tier 2a — α_common = 2/(27π) = 0.02358, target M_c(D7) revised 2.094→1.57×10¹⁵ GeV, α_s error improved 11%→8.1%, coupling table updated; AUDIT equations/alpha_s_target.py: BETA updated to 1/(9π), g_common²=8/27 exact, output verified M_c(D7)_target=1.566×10¹⁵ GeV; strong_force.md α_s entry updated 11%→8.1%. | 69% | 45% | ~57% |
| 2026-05-21 | 120 | Stark effect formalized: phenomena/quantum/stark_effect.md + equations/stark_effect.py — quadratic Stark ΔE=−½αE² (α=4.5a₀³×4πε₀, Tier 1); linear Stark ΔE=3ea₀E (n=2, Tier 1); DFC error +6.8% in α_pol from α_em chain (same source as all EM); DFC a₀ 2.21% too large (α_em(m_e)=1/140.1 vs 1/137); Stark/Zeeman energy ratio 2.74× at lab fields; BUG FIX equations/quark_gluon_plasma.py: factor-of-2 RG running error corrected (log_ratio=2×log→log); old 653% T_c error was artifact; correct one-loop result is −80% (blocked by non-perturbative regime, not α_s error); T_c estimate 1160→30 MeV; Λ_QCD one-loop 1841→89 MeV; quark_gluon_plasma.md Consistency Checks and T_c section updated; AUDIT superconductivity.md: wrong "D7 acoustic modes" label for phonons removed; phonons correctly identified as D3/D4 substrate oscillations; josephson_effect.md/py added to Connections. | 69.5% | 45.5% | ~57.5% |
| 2026-05-21 | 121 | Hydrogen fine structure formalized: phenomena/quantum/fine_structure.md + equations/fine_structure.py — exact Dirac formula dirac_energy_nj(n,j,α); 2P₃/₂−2P₁/₂ splitting ΔE=43.3 μeV (obs 45.3 μeV, −4.5% = 4×α_em systematic); α⁴ scaling verified (residual 3.4e-04, Tier 1); Tier 1: Dirac eq. from D6 JR dynamics, three corrections from one equation, positive SO sign. | 70% | 46% | ~58% |
| 2026-05-21 | 122 | τ lepton mass mechanism — Koide formula: equations/tau_mass_koide.py (new) — Koide formula holds < 10 ppm (verified); m_τ predicted from m_e+m_μ = 1776.97 MeV (obs 1776.86 MeV, error +0.006%, 0 free params); Z₃ circle parametrization: v=17.72 MeV^(1/2), φ=132.7°, all three masses fit <0.01%; SU(3)/Z₃ decomposition: |s⊥|²/|s∥|²=0.999982 (Koide: 1), angle=44.9997° (Koide: 45°); DFC mechanism: Z₃ ⊂ S₃ permutation of three coincident D7 kinks → circulant Yukawa → Koide formula; Tier 3 candidate (needs: prove Yukawa circulant from D7 substrate field eq); replaces failed dimple model (8.4× wrong); foundations/three_generations.md Open Q6 added; ISSUES.md τ failure updated; α_s error updated 11%→8.1%. | 70.5% | 46.5% | ~58.5% |
| 2026-05-21 | 123 | Koide algebraic structure formalized — Tier 1 proofs: equations/koide_yukawa_circulant.py (new) — THEOREM 1: Koide K=2/3 ↔ |F₀|/|F₁|=√2 (DFT condition, proved algebraically + numerically, residual <1e-10); THEOREM 2: Z₃ cyclic invariance ↔ circulant structure (proved, max|CYC†-Y|=0.00e+00); THEOREM 3: mass circulant eigenvalues = DFT of (√m_e,√m_μ,√m_τ) (proved, eigenvalue match <7e-15); three equivalent Koide formulations verified: K=2/3, |F₀|/|F₁|=√2, angle=45° (all consistent <10 ppm); open: Step 3 (Yukawa Z₃-invariant, Tier 3), Step 4 (|F₀|/|F₁|=√2 from V(φ), Tier 4); AUDIT coupling_derivation.md: stale "critical next calculation" paragraph corrected (B2 was closed Cycle 117!); M_c(D7) target 2.094→1.566×10¹⁵ GeV; α_s error 11%→8.1%; Open Problems table updated; 12 new equation file connections added. | 71% | 47% | ~59% |
| 2026-05-22 | 124 | Koide Step 3 formalized — Z₃ isometry → circulant Yukawa (Tier 3): equations/koide_step3_yukawa.py (new) — (A) Z₃ cyclic C ∈ SU(3) verified (det=+1, unitarity err 0, order err 0); (B) Z₃-symmetric Gaussian mode profiles at θ_k=2πk/3 → numerical overlap matrix Y is circulant (max err 3.33e-16) and [Y,C]=0 (err 3.33e-16); (C) algebraic proof: CY_{ij}=Y_{i+1,j}=r_{(j-i-1)%3}=YC_{ij} → any circulant commutes with C (general complex Hermitian: comm err 0.00e+00); (D) real symmetric circulant gives λ₁=λ₂ (degenerate); D5 complex structure (Cycle 117) needed for complex circulant with distinct masses; (E) Koide ratio |F₀|/|F₁|=1.41421365 (√2=1.41421356, 6.16e-08 deviation, <10 ppm); Step 4 (|F₀|/|F₁|=√2 from V(φ)) Tier 4 OPEN; AUDIT phenomena/particle_physics/particles/muon_tau.md: One-Sentence Synthesis updated with Koide mechanism; Dimensional Folding Explanation extended with Koide formula, 4-step chain, status; Consistency Checks: Koide row added (+0.006% Tier 3); Open Questions rewritten (Q1: promote Koide to Tier 2; Q2: excited-mode route); Connections: 4 new refs (tau_mass_koide.py, koide_yukawa_circulant.py, koide_step3_yukawa.py, zero_mode_multiplet.md); AUDIT equations/mass_spectrum.py: docstring updated with Koide alternative; __main__ extended with Koide cross-ref block; ISSUES.md updated: last-updated date, tau mass failure extended, M_c(D7) target corrected (2.094→1.566×10¹⁵ GeV), α_s error corrected (11→8.1%), three_generations.md Koide steps added, Resolved entries for Koide algebraic (Cycle 123) + B2 (Cycle 117). | 71.5% | 47.5% | ~59.5% |
| 2026-05-22 | 125 | Koide Step 4 BPS connection: equations/koide_step4_bps.py (new) — CENTRAL FORMULA |F₀|/|F₁|=2/√Q_top (Tier 3): since Q_top=2 (Tier 1, Cycle 111), formula gives |F₀|/|F₁|=√2 = Koide condition; algebraic proof |F₀|=3v (sum of cos(θ_k) vanishes, Z₃-exact), |F₁|=(3v·r/2)e^{−iφ} → ratio=2/r; error 3.55e-15 for any (phi,r); r²=Q_top verified from observed lepton masses to 18 ppm (experimental mass precision limit); Parseval: Q_top=4|F₁|²/|F₀|² (error 18 ppm from masses); BPS field at Z₃ positions: tanh non-linearity means R₀≠√Q_top·ξ (open Tier 4 gap: derive r=√Q_top from DFC 5D action); reconstruction error 1.60e-14 (machine precision); Koide proof chain Steps 0–4 all Tier 3; Step 4 open gap Tier 4; AUDIT three_generations.md Open Q6: extended with full 5-step Koide chain status (Steps 0–4, Tier assignments, open gap); ISSUES.md: τ mass failure entry updated with Step 4 Tier 3 status and open Tier 4 gap. | 72% | 48% | ~60% |
| 2026-05-22 | 126 | Koide Theorem 4 — K=2/3↔t²=1/Q_top at γ=2π/3 (Steps 4a–4c Tier 1): equations/koide_complex_circulant.py (new) — complex circulant Yukawa (first row 1, t·e^{iγ}, t·e^{i2γ}) — THEOREM 4: at γ=2π/3 eigenvalues are (1−t, 1−t, 1+2t); sum S=3 t-independent; K=1/3+2t²/3 (algebraic, error 1.11e-16 at t=1/√Q_top); K=2/3 ↔ t²=1/Q_top exactly; Theorem 4a: γ=2π/3 from π₁(S¹)=ℤ D5 vortex + Z₃ geometry (Tier 1); Theorem 4b: K=1/3+2t²/3 algebraic identity at γ=2π/3 (Tier 1); Theorem 4c: K=2/3 ↔ t²=1/Q_top=1/2 ↔ t=1/√Q_top (Tier 1); universality: r=√Q_top universal on K=2/3 curve for ALL γ near 2π/3 (PASS); open Tier 4: derive t=1/√Q_top from DFC 5D Yukawa overlap integral with D5 vortex background; complete proof chain: Steps 0–2 Tier 1, Step 3 Tier 3, Steps 4a–4c Tier 1, Step 4d Tier 4 open; STATUS: ALL CHECKS PASS. | 72.5% | 48.5% | ~60.5% |
| 2026-05-22 | 127 | Koide Step 4d: Yukawa overlap — t=1/√Q_top from phase zero mode normalization: equations/koide_yukawa_overlap.py (new) — 5 approaches tested; Approaches 1,3 give t=1 (global phase/constant vortex); Approach 2 (half-vortex) t=0.774 (35% error); Approach 5 (mixed metric) t=0.816 (15% error); Approach 4 (phase mode norm) PASS (error 1.11e-16); moduli metric summary: g_XX=I₄ (err 1.28e-07), g_{θθ}=Q_top (err 1.69e-12), g_{Xθ}=−5.55e-16≈0 (parity exact), det(g)=2I₄; Tier 3 result: t=1/√g_{θθ}=1/√Q_top from canonical normalization of phase zero mode (off-diagonal Yukawa couples through phase mode with norm √Q_top; diagonal position mode norm cancels); Tier 4 open: compute F(γ)=|∫η₀²·e^{iΔθ(x)}dx|/I₄=1/√Q_top explicitly from D5 vortex BVP phase profile; AUDIT electron.md: tau mass section updated with Koide formula alternative; Consistency Checks: Koide row added (+0.006% Tier 3); Connections: tau Koide files + parity_violation.md added. | 73% | 49% | ~61% |
| 2026-05-22 | 128 | Wiedemann-Franz law formalized: equations/wiedemann_franz.py (new) — L₀=π²k_B²/(3e²)=2.443×10⁻⁸ W·Ω·K⁻² (Tier 1 universality: τ/m* cancels in κ/σ ratio for single D5 carrier type); DFC L₀=2.498×10⁻⁸ (+2.24%, same α_em systematic as all EM); 6 metals compared (mean L/L₀=0.998, −0.2%); quantum thermal conductance G_Q=π²k_B²T/(3h) (Tier 1); SIGN FIX: multiple occurrences of wrong "−2.2%" corrected to "+2.2%" (e_DFC < e_obs → L₀_DFC > L₀_obs); AUDIT heat_and_conductivity.md: Formal Equations section added (Wiedemann-Franz, G_Q); Wiedemann-Franz Open Q updated (Tier 1 now answered); Connections extended (wiedemann_franz.py, superconductivity, josephson, QHE). | 73% | 50% | ~61.5% |
| 2026-05-22 | 129 | Blackbody radiation formalized: equations/blackbody_radiation.py (new) — Planck spectrum u(ν,T)=8πhν³/c³/(e^{hν/kT}−1) Tier 1 from KG dispersion + Bose-Einstein + 2 polarizations; CRITICAL BUG FIX Wien's law domain: x_ν=2.8214 (du/dν=0) ≠ x_λ=4.9651 (du/dλ=0); standard Wien constant b=2.898e-3 m·K uses x_λ (λ-domain peak), NOT x_ν; hc/(2.821k)=5.10e-3 m·K is WRONG; fixed in both equations/blackbody_radiation.py and phenomena/thermodynamics/blackbody_radiation.md (Formal Derivations section + Consistency Checks table); Stefan-Boltzmann σ exact (error 0.0000%); Wien b error 0.000%; CMB T=2.7255 K verified; E=hν POSTULATE labeled (ℏ not derived); AUDIT foundations/mass_hierarchy.md: Koide formula Tier 3 account added (m_τ=1776.97 MeV, 0.006%, 0 free params, Z₃ circulant Yukawa mechanism); Open Questions (4 items) and Connections sections added; tau dimple failure relabeled "dimple model failure" to distinguish from Koide account; AUDIT equations/anomalous_magnetic_moment.py: BETA_DFC updated 0.0351→1/(9π) Tier 2a (Cycle 117); g_eff²=8/27 exact output; α_s "11%"→"8.1%" (Cycle 119); docstring updated with full derivation chain; free params: 1→1 (m_e only; β now derived). | 73% | 50.5% | ~62% |
| 2026-05-23 | 135 | Spontaneous emission formalized: equations/spontaneous_emission.py + phenomena/quantum/spontaneous_emission.md (new) — Einstein A coefficient from DFC α chain; A=4αω³|r₁₂|²/(3c²) Tier 1; α⁵ scaling PROVED algebraically (a₀∝1/α, ω∝α²→A∝α⁵, residual 3.72e-16, Tier 1); 2p→1s first-principles: A_obs=6.269e8 s⁻¹ (NIST 6.265e8, 0.06%); DFC self-consistent: all 8 H transitions +11.7% too long (Tier 2b, same α_em systematic); mean error +11.7% (uniform); AUDIT equations/nuclear_binding.py: α_s 0.105→0.1086 (8.1%), "11%"→"8.1%", ECCC M_c(D7) cross-refs (confinement.py, alpha_s_target.py, mc_closure_scales.py), deuteron B-W failure note added. | 65% | 54% | ~65% |
| 2026-05-23 | 134 | QCD confinement from DFC dimensional transmutation: equations/confinement.py (new) — Λ_QCD^DFC=45.9 MeV (obs 210–340 MeV, −83%, Tier 2b); b₀^QCD(nf=6)=7=11−4; structural identity b₀^QCD=(N_Hopf+Q_top)−(2/3)×nf=11−4; 83% error explained by 8.1% α_s systematic amplified ~38× by exponential formula; Section 2: threshold running gives α_s(1 GeV)=0.0123 (near-perturbative at 1 GeV; Landau pole pushed below 1 MeV — blocked by α_s 8.1% systematic, not model failure); Section 3: both QCD and EWSB use Λ=μ_UV×exp(−8π²/(b₀ g_eff²)) — identical formula, b₀_EW=11=N_Hopf+Q_top vs b₀_QCD=7=b₀_EW−(2/3)×nf; v/Λ_QCD ratio 6365 vs observed 911 (600% error — traces to α_s gap); AUDIT strong_force.md: Consistency Checks table extended (Λ_QCD row added), Open Q2 updated (computed 45.9 MeV, source of 83% error identified), Connections extended (confinement.py, d6_gauge_beta.py, mc_closure_scales.py); 11%→8.1% corrected in note. | 64.5% | 53.5% | ~64.5% |
| 2026-05-22 | 133 | D6 gauge beta function survey: equations/d6_gauge_beta.py (new) — systematic one-loop b₀ survey for SU(N) with matter; NEW TIER 1: SU(2) CANNOT drive EWSB — b₀_max(SU(2))=22/3≈7.33 < b₀_needed≈10.92 (rigorously proved); NEW STRUCTURAL IDENTITY: b₀_needed≈N_Hopf+Q_top=9+2=11=b₀(SU(3) pure gauge); TIER 3 CANDIDATE: v=M_c(D6)×exp(−27π²/11)=292 GeV (+19%, 0 free params); with instanton measure prefactor √(2π/11): v=221 GeV (−10%); needed DFC prefactor A≈0.842 unresolved; interpretation: D7 SU(3) pure gauge dynamics (b₀=11) evaluated at D6 scale generates EW scale via dimensional transmutation analogous to QCD; foundations/vev_derivation.md Open Problem 6 updated with Cycle 133 findings. | 75% | 53% | ~64% |
| 2026-05-22 | 132 | EWSB root-cause analysis: equations/ewsb_mechanism.py (new) — 6 routes to v=246 GeV analyzed; NEW TIER 1 STRUCTURAL: SM RGE cannot drive EWSB in DFC — λ_DFC=β/4=+0.0088 is positive UV BC at M_c(D6), λ stays positive all the way to M_Z (one-loop running verified); DFC STABILIZES SM vacuum rather than breaking it dynamically; explicit α_D6≈1070 GeV² required; DFC hierarchy problem quantified: α_D6^nat=2M_c(D6)²=1.88e26 GeV², suppression=5.7×10⁻²⁴ (23.2 orders), Δ_EW=24.4; 5 other routes: (A) natural DFC 1.8×10²³× too large, (C) soft mass depth-running γ_Higgs≈γ_space ratio fails by 2.8×10²⁴×, (D) NP condensate exp(−c/g²) c_needed≈15.7 (brackets π²=9.87 and 2π²=19.74) MOST PROMISING, (E) power law p≈10.4 unnatural; foundations/vev_derivation.md: Cycle 132 status block added; Open Problem 6 (NP condensate route) added; ewsb_mechanism.py cross-ref added. | 74.5% | 52.5% | ~63.5% |
| 2026-05-22 | 131 | Bottleneck 3 gap analysis formalized: equations/d6_d7_overlap.py (new) — required I_D67=β v²/(4M_c(D7)²)=2.18×10⁻²⁸; narrow-kink sech² overlap=exp(−Δ_D67)≈0.006; gap=2.8×10²⁵ (25 orders); 4 routes analyzed (cascade N=12.7 needed/DFC has 4, power law p≈2.16, one-loop radiative, D6-anchored n≈9.5); gap IS hierarchy problem in DFC language; power-law p≈2.16 most promising (must derive p from D6/D7 mode structure); PROPAGATE ECCC scales: vev_derivation.py (β=1/(9π), M_c(D56)=9.70e12, M_c(D7)=1.566e15), vev_derivation.md (Cycle 131 status block, d6_d7_overlap.py cross-ref); AUDIT pauli_exclusion.md: "D3 space" → "D3 localization configuration" language fix; AUDIT bifurcation_dynamics.py: M_c(D5) 1.02e13→1.1435e13 (ECCC), β 0.035→1/(9π) Tier 2a, status output updated. | 74% | 52% | ~63% |
| 2026-05-22 | 130 | ECCC (Equal-Coupling Closure Condition) formalized: equations/mc_closure_scales.py (new) — correct DFC condition α_i(M_c(Di))=g_eff²/(4π)=2/(27π) for each gauge sector independently; M_c(D5)=1.14×10¹³ GeV, M_c(D6)=9.70×10¹² GeV, M_c(D7)=1.57×10¹⁵ GeV (all ECCC-derived, self-consistent, circular for α_s); NON-CIRCULAR predictions: co-crystallization M_c(D5)/M_c(D6)=1.18 (Tier 1 structural), Δ_D67=5.08 (Tier 3 Bottleneck 3 input); wrong old condition: α₁∩α₃ crossing (8×10¹⁴ GeV, coupling 5% above α_common); AUDIT foundations/alpha_s_derivation.md: ECCC section added, 11%→8.1% corrected in table and Current Gap section, ECCC cross-ref, Cycle 130 status block added; AUDIT equations/alpha_s_target.py: ECCC block added, MC_D7_ECCC constant added, docstring updated (8.1% error); AUDIT ISSUES.md: α_s entry extended with ECCC findings and non-circular predictions, Blocked Derivations M_c(D7) updated; AUDIT equations/depth_running.py: β updated 0.0351→1/(9π) Tier 2a, α_common corrected 0.0234→0.02358, ECCC section replaces old crossing output, α_s_mz corrected 0.118→0.1182, 11%→8.1%. | 73.5% | 51.5% | ~62.5% |
...
Next milestone: prove structural identity A−B = ln(1/α_em(0)) algebraically (Tier 4→1) — closes α_em(0) gap and α_s gap simultaneously; Koide Step 4d Tier 3→2a (F(γ)=1/√Q_top from vortex BVP); Bottleneck 3 v=247.83 GeV Tier 3→2a.
...
| 2026-04-30 | 91 | equations/scattering_length.py (new): effective range theory from exact n=2 PT T-matrix (Cycle 89) — scattering length a_s=3/M_c=3λ (exact, 0 free params); effective range r₀=11/(6M_c)≈1.833λ (exact, 0 free params); Wigner time delay τ_W(q)=−2M_c/(q²+M_c²)−4M_c/(q²+4M_c²) always negative (time-advancing reflectionless potential); τ_W(0)=−a_s (exact identity); Born vs exact comparison (Born diverges at q→0, exact finite); a_s/λ=3.000000 verified to 1.56e-10; all results parameter-free in units of λ=1/M_c. foundations/kink_scattering.md updated: Status block, new Effective Range Theory section (a_s/r₀/τ_W derivations with natural-language statements), Numerical Results table extended, Summary table extended (4 new rows). AUDIT phenomena/particle_physics/forces/electroweak.md: added Consistency Checks table (10 rows); Open Q1 updated (sin²θ_W RESOLVED Route 3B <0.01%); DFC predictions M_W=79.67 GeV/M_Z=90.86 GeV/G_F=1.168×10⁻⁵ GeV⁻² added to Precision Observables; new Connections to muon_lifetime.py, electroweak_precision.py, vev_derivation.md. AUDIT equations/entropy_production.py: Cycle 45 Z₂ irreversibility proof cross-referenced in arrow_of_time_metric() and Status section added to output. | 58.5% | 33.5% | ~46% |
| 2026-05-01 | 92 | equations/kink_form_factor.py (new): kink charge form factor F(k)=πκ(κ²+4)/(8 sinh(πκ/2)) proved via Beta integral B(2−iκ/2, 2+iκ/2); charge radius ⟨r⟩_rms=√((π²−6)/4)/M_c≈0.984λ (exact, 0 free params, Tier 1); FT[sech⁴] formula verified numerically to 2.94e-15; scale hierarchy table: ⟨r⟩≈0.984λ, r₀=1.833λ, a_s=3λ, r_U1≈21.4λ; all parameter-free. foundations/kink_scattering.md updated: new Form Factor section, Summary table extended (2 new rows). AUDIT foundations/route1_skyrme.md: Open 3 (parity violation) updated to RESOLVED (Cycle 41); Bottleneck 1 closure (Cycles 59–74) added to Critical Bridge Problem; new cross-refs to zero_mode_multiplet.md, mode_count_threshold.md, threshold_nondegeneracy.md, parity_violation.md. AUDIT equations/bell_correlations.py: stale "Formal proof OPEN" corrected to "PROVED (Cycle 35)" in DFC interpretation output. | 59% | 34% | ~46.5% |
| 2026-05-05 | 103 | equations/beta_from_laplacian.py (new): β=1/(9π) self-consistency formalized — (A) r_U1/λ=1/(βI₄) [kink holonomy] equated with (B) r_U1/λ=πN_Hopf/I₄ [Hopf Laplacian sum]; λ₁(S^d)=d proved (Obata theorem, error 0.00e+00); N_Hopf=1+3+5=9; g²=8/27 from both routes (residual 0.00e+00); α-independence across 9 α values (error 0.00e+00); M_W error 0.50% (improved from 0.88%); Tier summary: Laplacian/N_Hopf/I₄ all EXACT, g²=8/27 TIER 3, r_U1/λ=πN_Hopf/I₄ TIER 4 OPEN. Cycle 102: hopf_fibration_geometry.md updated (Section 2b; g²=2I₄/N_Hopf; Summary table; Connections). Step 3 audit: scattering_length.py clean. | 62.5% | 38.5% | ~50.5% |
| 2026-05-05 | 101 | equations/beta_constraint.py (new): β derivation candidates analyzed — candidates (a) kink-width=L_Pl, (b) S_kink/ℏ=n, (c) ΔV/E_kink all BLOCKED (α-dependent or β-free); NEW candidate (d) β=1/(9π) from Hopf fiber dim sum 1+3+5=9 at D5/D6/D7 — gives g²=8/27 exactly (=(2/3)³, error<2×10⁻¹⁶), g=0.54433 (0.006% vs SM 0.5443), r_U1/λ=27π/4≈21.21 (0.91% from target); α-independence verified; status Tier 3. ISSUES.md updated (Cycles 97–101). coupling_derivation.md Cycle 101 status added. | 62% | 38% | ~50% |
| 2026-05-05 | 100 | equations/bottleneck2_beta_selfconsistency.py (new): B2 ↔ β-derivation structural equivalence PROVED — self-consistent β_B2=27/(256π)≈0.03357 makes mode_norm=9/(64π) exactly (error 0.00e+00); g²=9/32 exact (error 5.55e-17); α-independence across 5 α values (error <5.55e-17); 3-step chain (f²=I₄φ₀²/λ → r_U1=λ/(βI₄) → g²=2πβI₄) complete given β; three β values compared (reference 0.035/Route F 0.03536/B2 0.03357); β_B2 degrades M_W from −0.88% to −2.92% (tension documented); closing B2 = deriving β from V(φ) with zero additional free parameters. foundations/coupling_derivation.md updated: Cycle 100 status block, 3-step chain P1→P2→P3 explicit, next milestone updated. | 61.5% | 37.5% | ~49.5% |
| 2026-05-01 | 96 | equations/bottleneck2_2d_integral.py (new): Bottleneck 2 2D coupling integral — mode_norm=9/(64π) PROVED algebraically from g²=2πβI₄, r_U1=1/(βI₄), N_wv=(64π/9)M_c (error 0.00e+00, 0 free parameters beyond β); α-independence confirmed across 5 α values (error <1.55e-16); seven candidate vortex integrals computed: closest is simple KK 1/r_U1=4β/3=0.04667 (4.3% from target); angular gradient ∫g²/ρ² dρ=1.34 (30× target); 1D candidate=0.0746 (1.67× target); physical route (derive mode_norm from vortex BVP integral alone) still OPEN; vortex r_v=1.1004 ✓ (target 1.099); D6 zero mode normalization=1.0 ✓. | 60.5% | 36.5% | ~48.5% |
| 2026-05-01 | 95 | phenomena/quantum/wave_particle_duality.md: CRITICAL fix — circular E=hν logic corrected (E=ℏω is a postulate imported from QFT; same fix as light.md Cycle 42); BPS E_kink formula corrected (φ₀²λαc² was 2× too large → φ₀²/λ × c²); Born rule Open Q1 updated (spin case DERIVED Cycle 38 noted); 3 cross-refs added (born_rule_derivation.md, decoherence.md, special_relativity.py). AUDIT phenomena/thermodynamics/thermodynamics.md: missing arrow_of_time.md and phase_transitions.md added to Connections. AUDIT equations/entropy_production.py: stale "foundations/arrow_of_time.md" path corrected to "phenomena/thermodynamics/arrow_of_time.md" (both occurrences); module verified. ISSUES.md last-updated date updated to Cycles 89–95. | 60% | 36% | ~48% |
| 2026-05-01 | 94 | foundations/dfc_sm_lagrangian.md (new): full DFC–SM Lagrangian assembled term by term — L_gauge (g²=8πβ/3, KK step = B2 open), L_Higgs (λ_H=β/4 exact; μ_eff=23 GeV, B3 open), L_fermion (JR zero mode; kinetic coeff=1 exact; FR statistics), L_Yukawa (y_μ/y_e=206.77 Tier 2a; τ 8.4× fail); each term has DFC origin, derivation chain, and tier status; parameter count table shows only β,v = 2 free parameters. equations/lagrangian_verification.py (new): four-sector verification — I₄=4/3 exact (0.00e+00); f²=(8/3)M_c³/β α-independent (0.00e+00); g²=8πβ/3 (−0.75%); JR Dirac residual FIXED (was 8.67e-01, now 1.39e-17 ✓); Higgs mass CORRECTED — λ_H=β/4 is UV BC not SM quartic; CW prediction 124.4 GeV (−0.7%) cited from higgs_potential.py; all sectors clean. AUDIT quarks.md: Bottleneck 1 closure note (Cycles 59–74) added to Consistency Checks; equations/quark_masses.py, foundations/dfc_sm_lagrangian.md, equations/flavor_mixing.py, foundations/zero_mode_multiplet.md added to Connections. AUDIT equations/higgs_potential.py: equations/vev_derivation.py, foundations/dfc_sm_lagrangian.md, equations/lagrangian_verification.py cross-refs added to docstring; module verified (124.4±3.7 GeV ✓). | 60% | 35% | ~47.5% |
| 2026-05-01 | 93 | equations/z_boson_decays.py (new): Z boson partial and total decay widths from DFC coupling chain — Γ(Z→e⁺e⁻)=82.7 MeV (−1.56%), Γ_Z=2456 MeV (−1.56%), Γ_inv=493 MeV (−1.16%), R_l=20.75 (−0.10%), R_b=0.220 (+1.58%), A_FB^lep=0.0168 (+3.17%) all Tier 2a; A_FB^b=0.105 (+5.4%) Tier 2b (loop corrections needed); N_ν=3 Tier 1 exact; 7 new predictions from β+v with zero additional free parameters. phenomena/particle_physics/particles/w_z_bosons.md audited: Consistency Checks extended (8 new rows), Open Question 1 updated (sin²θ_W RESOLVED Route 3B), z_boson_decays.py added to Connections. AUDIT equations/baryogenesis.py: stale M_c(D7) reference updated (8×10¹⁴ estimate vs 2.094×10¹⁵ target), wrong file path baryogenesis.md corrected to phenomena/cosmology/, strong_cp.py cross-ref added (θ_QCD=0 RESOLVED Cycle 46). | 59.5% | 34.5% | ~47% |
...
| Electromagnetic fine structure constant at the Z boson mass scale (1/128) | alpha_em_prediction.py | 1/128.09 | 1/127.9 | +0.15% | 0 (36π: g_eff²+k_Y, Cycle 142) |
...
| Z boson total width (2495 MeV) | z_boson_decays.py | 2456 MeV | 2495.2 MeV | −1.56% | 2 (β; v=246 GeV) |
| Z→e⁺e⁻ partial width (83.98 MeV) | z_boson_decays.py | 82.7 MeV | 83.984 MeV | −1.56% | 2 (β; v=246 GeV) |
| Z invisible width (499 MeV) | z_boson_decays.py | 493 MeV | 499.0 MeV | −1.16% | 2 (β; v=246 GeV) |
| R_l = Γ_had/Γ_ll (20.767) | z_boson_decays.py | 20.746 | 20.767 | −0.10% | 2 (β; v=246 GeV) |
| R_b = Γ_bb̄/Γ_had (0.2163) | z_boson_decays.py | 0.2197 | 0.21629 | +1.58% | 2 (β; v=246 GeV) |
| A_FB^lep (0.01626) | z_boson_decays.py | 0.01677 | 0.01626 | +3.17% | 2 (β; v=246 GeV) |
| Common gauge coupling g_eff (0.5443) | d5_complex_from_instability.py | 0.54433 | 0.5443 | 0.006% | 0 (from V(φ) alone) |
| Quartic substrate coupling β | d5_complex_from_instability.py | 0.03537 | 0.03537 | 0.000% | 0 (β=1/(9π), self-consistent) |
...
|---|---|---|---|---|---|
| Electron anomalous magnetic moment (leading Schwinger term) | anomalous_magnetic_moment.py | 0.001160 | 0.001160 | −0.14% | Leading term only; α_em systematic from 36π chain (Cycle 142) |
...
| Strong coupling constant at the Z boson mass scale | alpha_s_target.py | 0.1086 | 0.1182 | 8.1% | Improved from 11% (Cycle 119, β=1/(9π)); M_c(D7) target 1.57×10¹⁵ GeV |
