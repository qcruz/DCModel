...
(Balaban RG done C194; SP1i Seiler-Simon T4→T2a done C195; C196: c_gauge(n=1)=0 T1 by parity; C197: Jost integral c_gauge(cont)=2.773 T2a, C_match=0.7952 T2a, SP5 threshold T3→T2a; C198: SP1 finite-volume T3→T2a (ym_sp1_finite_volume.py); remaining: SP1 infinite-volume L→∞ [T3] + continuum a→0 [T4 Balaban formal], SP5 M_c(D7) T4).
