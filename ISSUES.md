...
**Last updated:** 2026-06-14 (Cycles 122–264)
...
- **Status:** Active primary focus. Last updated: Cycle 264.
...
**Latest:** C264: SP5 c_ghost analytic — c_ghost_naive=1.4407 [T2a]; δF_ghost Lorentzian T1; adjoint color factor C_A/C_F=9/4 needed for c_ghost→2.78≈c_gauge; T4 SU(3) color structure remains. C263: ECCC identity A−B=ln(1/α_em(0)) T2a [9/9 PASS], exp(A−B)=136.976 (−0.044%). C259: Ghost Jost integral c_ghost≈2.47 [T3]. C258: SP4 100% [12/12 PASS]. C257: SP5 tree-level C_match T2a. **All 5 SP: SP1+SP2+SP3+SP4 at 100%, SP5 at 97%. Clay ~82%.**
---
