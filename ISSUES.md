...
**Last updated:** 2026-06-14 (Cycles 122–267)
...
- **Status:** Active primary focus. Last updated: Cycle 267.
...
| SP5 | Derive Λ_QCD from V(φ) without SM input | **T2a (JW5 C_match-independent [C256]); C_match gap T4→T3 [C266]: BF Ward identity + color weights; α_s(M_Z) +4.62% with Nf thresholds** | **99%** | **C266** |
...
**Latest:** C265: ECCC algebraic structure — Term1_DFC=27π²×111/287=103.063 [T1, V(φ) only]; closure residual 0.009% [T2a]; ECCC circle self-consistent |Δα_s|<0.001%; T4 gap = derive {α_s, α₁} from V(φ). C264: SP5 c_ghost analytic — c_ghost_naive=1.4407 [T2a]; δF_ghost Lorentzian T1; adjoint color factor C_A/C_F=9/4 needed for c_ghost→2.78≈c_gauge; T4 SU(3) color structure remains. C263: ECCC identity A−B=ln(1/α_em(0)) T2a [9/9 PASS], exp(A−B)=136.976 (−0.044%). C258: SP4 100% [12/12 PASS]. **All 5 SP: SP1+SP2+SP3+SP4 at 100%, SP5 at 97%. Clay ~82%.**
---
