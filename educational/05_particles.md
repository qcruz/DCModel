...
The three neutrino mass eigenvalues are related to the three-generation structure of D6 topology. The equal-depth-spacing DFC prediction gives m₃/m₂ = κ = 5.33, which is −8.3% below the observed 5.824. A structural correction (Tier 3) resolves this:
...
```
m₃/m₂ = κ^(1 + 1/(6π)) = 5.8248    (observed: 5.824, +0.010%, Tier 3)
```
...
(The old reported value of "4.3×" was a metric error; the actual uncorrected gap is −8.5%.)
